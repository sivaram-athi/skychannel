...
const AddRoom = ({ setRoom, onRoomAdded }) => {
  ...
  const handleSubmit = () => {
    ...
    axios({
      url: "https://beedesk.skyhms.in/skychnl/store_room_type",
      method: "POST",
      headers: {
  ...
  return (
    <Container>
      <Header>
        ...
        <ButtonGroup>
          <Button className="cancel" onClick={() => setRoom(0)}>
            Cancel
          </Button>
